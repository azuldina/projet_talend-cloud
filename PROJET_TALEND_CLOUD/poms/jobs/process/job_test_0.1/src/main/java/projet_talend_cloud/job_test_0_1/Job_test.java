...
///////////////////////    			
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:3e7FWiKhmNq0S2FdgL0Rtyb+ZbrYlxmq4gcJLNBT6p1a")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:Trollx3xHOusg0fOg8ztE6T8zmicUxQWuuk01THuqLqR");
	...
	public int runJobInTOS(String[] args) {
			...
			class ContextProcessing {
				private void processContext_0() {
					...
					if (context.getStringValue("connection_Mysql_AdditionalParams") == null) {
						...
						context.connection_Mysql_AdditionalParams = (String) context
								.getProperty("connection_Mysql_AdditionalParams");
					}
					...
					if (context.getStringValue("connection_Mysql_Password") == null) {
						...
						if (pwd_connection_Mysql_Password_value != null) {
							if (context_param.containsKey("connection_Mysql_Password")) {// no need to decrypt if it
																							// come from program
								...
								try {
									context.connection_Mysql_Password = routines.system.PasswordEncryptUtil
											.decryptPassword(pwd_connection_Mysql_Password_value);
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("connection_Mysql_Database")) {
			...
			if (parentContextMap.containsKey("connection_Mysql_AdditionalParams")) {
				context.connection_Mysql_AdditionalParams = (String) parentContextMap
						.get("connection_Mysql_AdditionalParams");
			}
			if (parentContextMap.containsKey("connection_Mysql_Password")) {
				context.connection_Mysql_Password = (java.lang.String) parentContextMap
						.get("connection_Mysql_Password");
			}
...
/************************************************************************************************
 * 112347 characters generated by Talend Cloud Data Management Platform on the
 * 17 avril 2022 à 19:12:40 CEST
 ************************************************************************************************/