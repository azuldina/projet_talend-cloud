...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_1{
                    ...
                    log4jParamters_tDBConnection_1.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:TWGG+cR9RUXi1gs2dKiTj4DK1T4CuhP8Y/4VmdVpiYYH").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_1.append(" | ");
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:4nSe7DzHw+TKbyCMZW7o0LphbyE2trYTRbdKhpnhMKUS");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tWarn_3{
                    ...
                    log4jParamters_tWarn_3.append("Parameters:");
                            log4jParamters_tWarn_3.append("MESSAGE" + " = " + "\"test connexion ok\"");
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_3", "", Thread.currentThread().getId() + "", "WARN","","test connexion ok","", "");
            log.warn("tWarn_3 - "  + ("Message: ")  + ("test connexion ok")  + (". Code: ")  + (42) );
	globalMap.put("tWarn_3_WARN_MESSAGES", "test connexion ok"); 
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tWarn_4{
                    ...
                    log4jParamters_tWarn_4.append("Parameters:");
                            log4jParamters_tWarn_4.append("MESSAGE" + " = " + "\"test connexion KO\"");
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_4", "", Thread.currentThread().getId() + "", "WARN","","test connexion KO","", "");
            log.warn("tWarn_4 - "  + ("Message: ")  + ("test connexion KO")  + (". Code: ")  + (42) );
	globalMap.put("tWarn_4_WARN_MESSAGES", "test connexion KO"); 
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tWarn_1{
                    ...
                    log4jParamters_tWarn_1.append("Parameters:");
                            log4jParamters_tWarn_1.append("MESSAGE" + " = " + "\"connexion table ok\"");
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "WARN","","connexion table ok","", "");
            log.warn("tWarn_1 - "  + ("Message: ")  + ("connexion table ok")  + (". Code: ")  + (42) );
	globalMap.put("tWarn_1_WARN_MESSAGES", "connexion table ok"); 
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tWarn_2{
                    ...
                    log4jParamters_tWarn_2.append("Parameters:");
                            log4jParamters_tWarn_2.append("MESSAGE" + " = " + "\"connexion table ko\"");
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "", Thread.currentThread().getId() + "", "WARN","","connexion table ko","", "");
            log.warn("tWarn_2 - "  + ("Message: ")  + ("connexion table ko")  + (". Code: ")  + (42) );
	globalMap.put("tWarn_2_WARN_MESSAGES", "connexion table ko"); 
...
/************************************************************************************************
 *     134031 characters generated by Talend Cloud Data Management Platform 
 *     on the 20 avril 2022 à 12:18:55 CEST
 ************************************************************************************************/